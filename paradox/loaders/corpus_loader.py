...
def load_test_data_set(language, task_number, base=''):
...
def load_all_test_languages(base=''):
    languages = {'Malayalam', 'Tamil', 'Hindi', 'Punjabi'}
    data_sets = {}
    for language in languages:
        language_dict = {}
        language_dict['Task1'] = load_test_data_set(language, 1, base=base)
        language_dict['Task2'] = load_test_data_set(language, 2, base=base)
        data_sets[language] = language_dict
    return data_sets
